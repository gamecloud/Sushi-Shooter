...
import net.gamecloud.sushishooter.GameView;
import net.gamecloud.sushishooter.GameView.GameThread;

import net.gamecloud.sushishooter.R;
import com.sessionm.TransactionReceiver;
...
public class FrozenBubble extends Activity
{
  ...
  private static final String EDITORACTION = "net.gamecloud.sushishooter.GAME";
